...
/**
 * OP_SHA256 — mock implementation.
 * Pops the top element and pushes back the first 4 bytes as a simulated SHA256 hash.
...
public class OpSha256 implements Opcode {
    ...
    public void execute(ExecutionContext context) {
        ...
        if (stack.isEmpty()) {
            throw new RuntimeException("OP_SHA256 requires at least one element on the stack");
        }
        byte[] data = stack.pop();
