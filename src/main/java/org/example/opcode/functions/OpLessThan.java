...
/**
 * OP_LESSTHAN pops two items and pushes 1 if the second-to-top is less than the top, 0 otherwise.
 */
public class OpLessThan implements Opcode {
    ...
    public void execute(ExecutionContext context) {
        ...
        if (stack.size() < 2) {
            throw new RuntimeException("OP_LESSTHAN requires at least two elements on the stack");
        }
        int b = stack.pop()[0];
        int a = stack.pop()[0];
